import { RepeatWrapping, ClampToEdgeWrapping, MirroredRepeatWrapping, NearestFilter, NearestMipmapNearestFilter, NearestMipmapLinearFilter, LinearFilter, LinearMipmapNearestFilter, LinearMipmapLinearFilter, NeverCompare, AlwaysCompare, LessCompare, LessEqualCompare, EqualCompare, GreaterEqualCompare, GreaterCompare, NotEqualCompare, NoColorSpace, FloatType, UnsignedIntType, UnsignedInt248Type, DepthFormat, UnsignedShortType, DepthStencilFormat, RGBAFormat, _SRGBAFormat, LinearSRGBColorSpace, SRGBTransfer, UnsignedByteType, LinearTransfer, HalfFloatType } from '../../constants.js';
import { isPowerOfTwo, floorPowerOfTwo } from '../../math/MathUtils.js';
...
function WebGLTextures(_gl, extensions, state, properties, capabilities, utils, info) {
    ...
    function getInternalFormat(internalFormatName, glFormat, glType, colorSpace, forceLinearTransfer) {
        if (forceLinearTransfer === void 0) forceLinearTransfer = false;
